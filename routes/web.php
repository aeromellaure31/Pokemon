...
Route::group(['middleware' => ['jwt.verify']], function () {
    ...
    Route::post('/user-profile', [App\Http\Controllers\AuthController::class, 'userProfile']);
    ...
    Route::post('/retrievePokemon', [App\Http\Controllers\PokemonController::class, 'retrieveAllUserPokemon']);
});
