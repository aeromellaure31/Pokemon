      ...
      <div class="justify-content-center LoginCardContainer mb-5">
        <div class="card RegisterCard">
          <div class="card-body" style="text-align: center;">
            ...
            <p class="mb-2 pb-0 successMessage" v-if="successMessage">Account has beed Updated!</p>
...
export default {
  ...
  methods: {
    getInfo(){
      ...
      this.$axios.post(AUTH.url + "user-profile", params, AUTH.config)
      .then(response => {
    ...
    update(event) {
      if (this.validate()) {
        ...
        this.$axios
          .post(AUTH.url + "update-profile", parameter, AUTH.config)
          .then((response) => {
          ...
          .catch((error) => {
            if(error.response && e.response.status === 401){
              AUTH.deauthenticate()
            }
          });
      }
